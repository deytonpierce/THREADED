...
<body>
    <div class="container mt-4">
        ...
        <!-- Header for the page -->
        <h1 class="mb-4">Add a Thread!</h1>
        <!-- Form to add a new thread -->
        <form:form action="/threads/new/process" method="post" modelAttribute="thread">
            <div class="form-group">
                <!-- Label and input for thread name -->
                <form:label path="name" class="form-control-label">Thread Name:</form:label>
